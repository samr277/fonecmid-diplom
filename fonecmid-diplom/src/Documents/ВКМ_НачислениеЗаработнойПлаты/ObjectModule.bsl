...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Запрос.Текст =
		"ВЫБРАТЬ
		|	ВКМ_НачислениеЗаработнойПлатыНачисления.Ссылка КАК Ссылка,
	...
	// РАСЧЕТ ДВИЖЕНИЙ: Расчет отпуска
	Движения.ВКМ_ОсновныеНачисления.Записывать = Истина;
	...
	// РАСЧЕТ ДВИЖЕНИЙ: Расчет НДФЛ по всем начислениям
...
// Создание движений в регистре расчета Удержания
Процедура РассчитатьНДФЛ() 
	
Запрос = Новый Запрос;
	Запрос.Текст = "ВЫБРАТЬ
	|	ВКМ_ОсновныеНачисления.Сотрудник КАК Сотрудник,
	|	СУММА(ВКМ_ОсновныеНачисления.Сумма) КАК Результат,
	...
	|ВЫБРАТЬ
	|	ВКМ_ДополнительныеНачисления.Сотрудник,
	|	СУММА(ВКМ_ДополнительныеНачисления.Сумма),
	|	ВКМ_НДФЛ.Значение
	|ИЗ
	|	РегистрРасчета.ВКМ_ДополнительныеНачисления КАК ВКМ_ДополнительныеНачисления,
	|	Константа.ВКМ_НДФЛ КАК ВКМ_НДФЛ
