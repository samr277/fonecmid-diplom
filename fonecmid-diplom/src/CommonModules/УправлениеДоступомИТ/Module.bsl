...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//ВКМ_Добавление дополнительных постовляемых профилей пользователей от 20.10.2024
	
	// Профиль "Специалист".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Специалист";
	ОписаниеПрофиля.Идентификатор = "8337ad8d-339d-45be-91dd-07472f031cb7";
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "51bce363-ab4f-4c05-8c18-497b6a4e914c";
	...
	ОписаниеПрофиля.Идентификатор = "f1f518f3-1bce-4a5f-86ee-beb6135f43c0";
	...
	ОписаниеПрофиля.Идентификатор = "77014f7a-828c-4b8d-b218-9e0e8c7ef604";
	ОписаниеПрофиля.Наименование  =	НСтр("ru = 'Кадровик-расчётчик'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументовПоРасчетуЗарплаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ЧтениеОтчетаВыработкаСпециалистов");
